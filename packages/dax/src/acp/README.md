...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for dax.
...
- **Terminal Integration**: Full terminal support via dax's bash tool
...
ACP sessions map cleanly to dax's internal session model:
