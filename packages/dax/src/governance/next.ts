...
export namespace Permission {
  ...
  export const ask = fn(AskInput, async (input) => {
      ...
      // A governed permission request becomes canonical before it can enter
      // the live pending set. Child sessions write under their governing run.
      ...
      try {
        ...
        // Some legacy/integration callers use Permission without a persisted
        // Session. Any other authority read failure remains fatal.
