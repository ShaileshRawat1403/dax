...
export namespace Server {
      ...
      app
        ...
        .post(
          ...
          describeRoute({
            ...
            description: "Clean up and dispose the current DAX instance, releasing all resources.",
        ...
        .get(
          ...
          describeRoute({
            summary: "Get paths",
            description: "Retrieve the current working directory and related path information for the DAX instance.",
        ...
        .get(
          ...
          describeRoute({
            ...
            description: "Get a list of all available commands in the DAX system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List agents",
            description: "Get a list of all available AI agents in the DAX system.",
        ...
        .get(
          ...
          describeRoute({
            summary: "List skills",
            description: "Get a list of all available skills in the DAX system.",
  ...
  export async function listen(opts: {
    ...
    if (!server) {
      const detail =
        lastListenError instanceof Error
          ? `${lastListenError.name}: ${lastListenError.message}`
