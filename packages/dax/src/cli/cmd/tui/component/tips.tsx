...
const TIPS = [
  ...
  "Use {highlight}/follow{/highlight} to toggle pane follow mode (smart/live) while streaming",
  "Use {highlight}/eli12summary{/highlight} to show or hide ELI12 action summary cards",
  ...
  "Run {highlight}/connect{/highlight} to add OpenAI, Gemini, Anthropic, Ollama, and advanced providers",
  ...
  "Create {highlight}dax.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/dax/dax.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.dax/agent/{/highlight} for specialized AI personas",
  ...
  "Run {highlight}dax agent create{/highlight} for guided agent creation",
  "Use {highlight}/dax{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}dax github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/dax fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/dax{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in {highlight}.dax/themes/{/highlight} directory",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/ShaileshRawat1403/dax-tui{/highlight} for containerized use",
