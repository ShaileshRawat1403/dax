...
export function Session() {
  ...
  // Sync refined prompt from KV when it changes
  createEffect(() => {
    const kvValue = kv.get(DAX_SETTING.session_refined_prompt)
    if (kvValue && kvValue !== refinedPrompt()) {
      setRefinedPrompt(kvValue)
    }
  })
