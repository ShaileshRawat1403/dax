...
const { SkillsCommand } = await import("./cli/cmd/skills")
...
const { StartCommand } = await import("./cli/cmd/start")
const { SandboxCommand } = await import("./cli/cmd/sandbox")
const { SdlcCommand } = await import("./cli/cmd/sdlc")
const { DocsCommand } = await import("./cli/cmd/docs")
const { ApprovalsCommand } = await import("./cli/cmd/approvals")
const { TrustCommand } = await import("./cli/cmd/trust")
const { WorkerCommand } = await import("./cli/cmd/worker")
const { GovernanceCommand } = await import("./cli/cmd/governance")
const { PlanCommand } = await import("./cli/cmd/plan")
const { ArtifactsCommand } = await import("./cli/cmd/artifacts")
const { VerifyCommand } = await import("./cli/cmd/verify")
